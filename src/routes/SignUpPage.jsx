      ...
      >
        ...
        <fieldset className="flex flex-col w-full mb-4">
          ...
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          {errors.email && <span className="text-xl text-red-599">Email is required</span>}
        </fieldset>
        <fieldset className="flex flex-col w-full mb-4">
          ...
          <input
            ...
            {...register("password", {
              ...
              pattern: {
                value: new RegExp(
                  "^(?=.*[0-9])(?=.*[!@#$%^&*])(?=.*[a-z])(?=.*[A-Z]).{8,}$"
                ),message: 'Password must include at least one number, one special character, one lowercase letter, and one uppercase letter'
              },minLength:{value:8,message:'Must have atleast 8 characters'},maxLength:{value:64,message:"Maximum leangth is 64"}
            })}
            className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </fieldset>
